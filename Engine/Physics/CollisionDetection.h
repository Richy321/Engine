...
typedef void(*CollisionCallback)(std::shared_ptr<Manifold>& m, std::shared_ptr<ICollider>& a, std::shared_ptr<ICollider>& b);
using namespace glm;

void CircleVsCircle(std::shared_ptr<Manifold>& m, std::shared_ptr<ICollider>& colliderA, std::shared_ptr<ICollider>& colliderB)
{
...
void CircletoPolygon(std::shared_ptr<Manifold>& m, std::shared_ptr<ICollider>& colliderA, std::shared_ptr<ICollider>& colliderB)
{
...
void PolygontoCircle(std::shared_ptr<Manifold>& m, std::shared_ptr<ICollider>& colliderA, std::shared_ptr<ICollider>& colliderB)
{
...
void PolygontoPolygon(std::shared_ptr<Manifold>& m, std::shared_ptr<ICollider>& colliderA, std::shared_ptr<ICollider>& colliderB)
{
